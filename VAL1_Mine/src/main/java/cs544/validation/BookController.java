...
import cs544.exercise19_1.sample.NoSuchResourceException;
...
public class BookController {
    ...
    public String addCar(@ModelAttribute("book") Book book) {
        return "addCar";
    }

    @RequestMapping(value = "/addBook", method = RequestMethod.POST)
    public String add(@Valid Book book, BindingResult result, RedirectAttributes re) {
